...
Le chiffre d'affaires fantôme est particulièrement difficile à identifier car :

- il n'apparaît pas dans la comptabilité  
- il ne déclenche aucune alerte  
- il donne une illusion de performance  

Dans de nombreuses entreprises, il peut représenter entre 10 % et 30 % du chiffre d'affaires total.
...
Chacune de ces sources génère des pertes de chiffre d'affaires sans visibilité.
...
| Outils non connectés   | Inefficacité opérationnelle    |
